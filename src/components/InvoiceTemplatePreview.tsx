...
const InvoiceTemplatePreview: React.FC<InvoiceTemplatePreviewProps> = ({ config }) => {
  return (
    <Paper
      elevation={3}
      sx={{
        ...
        padding: '2.5cm 1.5cm 2cm 1.5cm', // Top: 2.5cm, Right/Left: 1.8cm (giảm từ 2.2cm), Bottom: 2cm
