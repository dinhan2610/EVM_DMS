    ...
    try {
      ...
      if (autoIssueAfterSign) {
        if (import.meta.env.DEV) {
          console.log(`⚡ Auto-issuing invoice ${signDialog.invoiceNumber} after signing...`)
        }
      ...
      setSnackbar({
        ...
        message: autoIssueAfterSign 
          ? `❌ Ký số và phát hành thất bại: ${errorMsg}`
          : `❌ Ký số thất bại: ${errorMsg}`,
        severity: 'error',
      })
    } finally {
